...
# Fit the model
estimator = KerasClassifier(build_fn=baseline_model, epochs=9, batch_size=10, verbose=0)
...
history = estimator.fit(X_train, train_y,validation_split=0.33,epochs=9,verbose=0,callbacks=[cb, es])
