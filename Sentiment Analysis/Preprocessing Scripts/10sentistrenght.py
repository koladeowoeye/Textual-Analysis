...
usedWords = ['islam','news','muslim','government','war','politics','rights','abortion','media','military','affairs','programs','security','counterterrorism','safeguard','officials','education','crime','officer','cnn','victim','video','twitter','trial','facebook','police','survivor']
wordfound = []
output = ""
print('===============================================================================================')
